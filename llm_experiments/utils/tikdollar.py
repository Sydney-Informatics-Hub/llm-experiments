    ...
    def decorator(func: Callable):
        ...
        def tikdollar_wrapper(*args, **kwargs):
            ...
            if not isinstance(prompt, str):
                raise TypeError("prompt must be a string. If you're using a prompt template, call .format() first.")
            ...
            num_input_tokens = count_input_tokens(model=llm.model_name, prompt=prompt)
